package net.sfelabs.knox.core.feature.hilt
...
import net.sfelabs.knox.core.feature.hilt.HiltPolicyRegistry
...
class HiltFeatureRegistryTest {
    ...
    fun `setComponents properly initializes delegate`() {
        ...
        // Then
        TestCase.assertTrue(hiltRegistry.isRegistered(mockKey))
