...
/**
 * Wrapper for PolicyState that helps maintain type safety and proper generic variance in the Policy system.
 *
 ...
 * 3. Ensures type safety when dealing with generic Policy types in the PolicyRegistry and other
 ...
 * - Have difficulty maintaining proper generic variance in the Policy class
 *
 * The wrapper acts as a bridge between the generic Policy system and specific PolicyState
